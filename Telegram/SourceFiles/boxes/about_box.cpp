...
rpl::producer<TextWithEntities> Text2() {
	return tr::lng_about_text2(
		...
		rpl::single(Ui::Text::Link(
			"GNU GPL",
			"https://github.com/kirsan31/tdesktop/blob/master/LICENSE")),
		lt_github_link,
		rpl::single(Ui::Text::Link(
			"GitHub",
			"https://github.com/kirsan31/tdesktop")),
		Ui::Text::WithEntities);
}
...
void AboutBox::prepare() {
	setTitle(rpl::single(u"Telegram Desktop mod"_q));
...
//	_text1->moveToLeft(st::boxPadding.left(), st::aboutTextTop);
	...
	_text2->moveToLeft(st::boxPadding.left(), /*_text1->y() + _text1->height() +*/ st::aboutTextTop);
