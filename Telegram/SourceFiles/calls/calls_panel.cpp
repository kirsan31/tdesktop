...
void Panel::initLayout() {
    _window->setAttribute(Qt::WA_ShowWithoutActivating);
    _window->setWindowFlags(Qt::Window | Qt::FramelessWindowHint | Qt::WindowSystemMenuHint | Qt::NoDropShadowWindowHint);
	initGeometry();
