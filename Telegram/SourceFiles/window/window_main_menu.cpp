...
, _version(this, st::mainMenuVersionLabel) {
	...
	_telegram->setRichText(textcmdLink(1, qsl("Telegram Desktop mod")));
	_telegram->setLink(1, std::make_shared<UrlClickHandler>(qsl("https://github.com/kirsan31/tdesktop")));
