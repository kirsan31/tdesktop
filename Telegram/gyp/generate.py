...
if 'TDESKTOP_ENABLE_SONNET_SPELLCHECK' in os.environ:
    sonnet = os.environ['TDESKTOP_ENABLE_SONNET_SPELLCHECK']
    gypArguments.append('-Dtdesktop_enable_sonnet_spellcheck=' + sonnet)
